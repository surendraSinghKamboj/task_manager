    ...
    <>
      <div className="relative">
        ...
        <div className="absolute w-full h-16 bottom-0 left-0 bg-[#4645453d] rounded-b-full">
          <label htmlFor="image">
            <FaEdit
              className="text-white text-2xl cursor-pointer absolute z-40 left-1/2 bottom-4 -translate-x-1/2 hover:scale-105 hover:opacity-80 transition-all duration-500"
            />
            <input
              type="file"
              name="image"
