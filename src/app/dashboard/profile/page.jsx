  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-96">
      ...
      */}
      ...
      <h4 className="w-1/2 border-b-2 border-t-2 border-secondary-700 text-center mt-4">Your Profile</h4>
      ...
      <div className="grid grid-cols-3 w-1/2 mt-2">
        ...
        <span className="col-span-2">{data.contact}</span>
         ...
         {/* -------------------------------------------------------------------
          ...
          -------------------------------------------------------------------
      */}
        <h4 className="w-1/2 border-b-2 border-t-2 border-secondary-700 text-center mt-4">Change Password</h4>
